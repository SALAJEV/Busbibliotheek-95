window.BB_TRANSLATIONS = {
  i18n: {
    nl: {
      ...
      idlePaused: "Realtime gepauzeerd na 5 minuten inactiviteit. Raak het scherm aan om verder te gaan.",
    ...
    fr: {
      ...
      currentStop: "Arret actuel",
      followOn: "Suivi: actif",
      followOff: "Suivi: inactif",
      lastUpdate: "Derniere mise a jour",
      idlePaused: "Temps reel en pause apres 5 minutes d'inactivite. Touchez l'ecran pour reprendre.",
    ...
    en: {
      ...
      idlePaused: "Real-time paused after 5 minutes of inactivity. Interact to resume.",
    ...
    de: {
      ...
      idlePaused: "Echtzeit nach 5 Minuten Inaktivitat pausiert. Interagiere, um fortzufahren.",
    ...
    pl: {
      ...
      currentStop: "Biezacy przystanek",
      followOn: "Sledzenie: wl",
      followOff: "Sledzenie: wyl",
      lastUpdate: "Ostatnia aktualizacja",
      idlePaused: "Realtime wstrzymane po 5 minutach bezczynnosci. Wykonaj akcje, aby wznowic.",
    ...
    es: {
      ...
      idlePaused: "Tiempo real en pausa tras 5 minutos de inactividad. Interactua para reanudar.",
    ...
    ru: {
      ...
      idlePaused: "Realtime na pauze posle 5 minut bezdeystviya. Vzaimodeystvuyte chtoby prodolzhit.",
